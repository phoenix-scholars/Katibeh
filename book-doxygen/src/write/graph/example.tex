...
نمونه نیز در شکل \ref{images/write/graph/example/diagram__a_8h__dep__incl} نمایش
...
مورد نظر در شکل \ref{images/write/graph/example/diagram__a_8h__dep__incl} پرونده
...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/write/graph/example/diagram__a_8h__dep__incl}
	\caption[]{
	
	}
	\label{images/write/graph/example/diagram__a_8h__dep__incl}
\end{figure}

\begin{note}
در شکلهای \ref{images/write/graph/example/class-a} و
\ref{images/write/graph/example/diagram__a_8h__dep__incl}
...
نموداری مشابه با شکل \ref{images/write/graph/example/class_b__coll__graph} ایجاد
خواهد شد. در این نمودار نه تنها نوع رابطه بلکه نام آن نیز نمایش داده می‌شود.

% FIXME: maso 1391: این نمایش از تصاویر مناسب نیست و باید به صورت کامل اصلاح شود
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/write/graph/example/class_b__coll__graph}
	\caption[]{
	
	}
	\label{images/write/graph/example/class_b__coll__graph}
\end{figure}
...
\ref{images/write/graph/example/diagram__c_8h__incl} نمایش داده شده است.

% FIXME: maso 1391: این نمایش از تصاویر مناسب نیست و باید به صورت کامل اصلاح شود
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/write/graph/example/diagram__c_8h__incl}
	\caption[]{
	
	}
	\label{images/write/graph/example/diagram__c_8h__incl}
\end{figure}
...
\ref{images/write/graph/example/class_d__inherit__graph} نمایش داده شده است.

% FIXME: maso 1391: این نمایش از تصاویر مناسب نیست و باید به صورت کامل اصلاح شود
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/write/graph/example/class_d__inherit__graph}
	\caption[]{
	
	}
	\label{images/write/graph/example/class_d__inherit__graph}
\end{figure}

با یک نگاه سطح در شکل \ref{images/write/graph/example/class_d__inherit__graph} به
...
\ref{images/write/graph/example/class_e__coll__graph} نمایش داده شده است.


% FIXME: maso 1391: این نمایش از تصاویر مناسب نیست و باید به صورت کامل اصلاح شود
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{images/write/graph/example/class_e__coll__graph}
	\caption[]{
	
	}
	\label{images/write/graph/example/class_e__coll__graph}
\end{figure}
